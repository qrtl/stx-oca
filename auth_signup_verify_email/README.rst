...
.. |badge3| image:: https://img.shields.io/badge/github-qrtl%2Fstx--oca-lightgray.png?logo=github
    :target: https://github.com/qrtl/stx-oca/tree/15.0/auth_signup_verify_email
    :alt: qrtl/stx-oca
...
`feedback <https://github.com/qrtl/stx-oca/issues/new?body=module:%20auth_signup_verify_email%0Aversion:%2015.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `qrtl/stx-oca <https://github.com/qrtl/stx-oca/tree/15.0/auth_signup_verify_email>`_ project on GitHub.
