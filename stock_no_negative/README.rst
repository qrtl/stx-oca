...
.. |badge3| image:: https://img.shields.io/badge/github-qrtl%2Fstx--oca-lightgray.png?logo=github
    :target: https://github.com/qrtl/stx-oca/tree/15.0/stock_no_negative
    :alt: qrtl/stx-oca
...
`feedback <https://github.com/qrtl/stx-oca/issues/new?body=module:%20stock_no_negative%0Aversion:%2015.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `qrtl/stx-oca <https://github.com/qrtl/stx-oca/tree/15.0/stock_no_negative>`_ project on GitHub.
